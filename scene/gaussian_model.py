...
class GaussianModel:
    ...
    def training_setup(self, training_args):
        ...
        l = [
            # {'params': [self._features_dc], 'lr': training_args.f_dc_lr, "name": "f_dc"},
            {'params': [self._features_rest], 'lr': training_args.f_rest_lr, "name": "f_rest"},
